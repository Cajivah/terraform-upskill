locals {
  generics_web_subnet_ids        = data.terraform_remote_state.generics.outputs.web_subnet_ids
  ...
  generics_alb_subnet_ids        = data.terraform_remote_state.generics.outputs.alb_subnet_ids
